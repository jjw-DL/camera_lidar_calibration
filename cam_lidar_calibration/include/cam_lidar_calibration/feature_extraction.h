...
namespace extrinsic_calibration {
    ...
    public:
        ...
        void visualize_end_points(pcl::PointCloud<pcl::PointXYZIR>::Ptr &left_points,
                                  pcl::PointCloud<pcl::PointXYZIR>::Ptr &right_points);

        void visualize_edge_points(pcl::PointCloud<pcl::PointXYZIR>::Ptr &left_down,
    ...
    private:
        ...
        struct RingFeature {
            pcl::PointXYZIR start_point;
            pcl::PointXYZIR end_point;
            double distance;
            int ring;
        };
        ...
        double plane_dist_threshold_, line_dist_threshold_;
        ...
        ros::Publisher pub_cloud, expt_region, debug_pc_pub;
